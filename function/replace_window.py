...
# Form implementation generated from reading ui file 'replace_window.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.groupBox.setGeometry(QtCore.QRect(0, 0, 151, 151))
        self.groupBox.setObjectName("groupBox")
        self.pushButton = QtWidgets.QPushButton(self.groupBox)
        self.pushButton.setGeometry(QtCore.QRect(10, 120, 51, 23))
        self.pushButton.setObjectName("pushButton")
        self.checkBox = QtWidgets.QCheckBox(self.groupBox)
        self.checkBox.setGeometry(QtCore.QRect(70, 124, 91, 16))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.checkBox.setFont(font)
        self.checkBox.setObjectName("checkBox")
        self.textEdit = QtWidgets.QTextEdit(self.groupBox)
        self.textEdit.setGeometry(QtCore.QRect(30, 20, 111, 41))
        self.textEdit.setObjectName("textEdit")
        self.label = QtWidgets.QLabel(self.groupBox)
        self.label.setGeometry(QtCore.QRect(10, 12, 16, 51))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.label_2.setGeometry(QtCore.QRect(10, 65, 20, 51))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.textEdit_2.setGeometry(QtCore.QRect(30, 70, 111, 41))
        self.textEdit_2.setObjectName("textEdit_2")
        self.groupBox_2 = QtWidgets.QGroupBox(Form)
        self.groupBox_2.setGeometry(QtCore.QRect(0, 160, 151, 171))
